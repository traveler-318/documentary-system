...
export function MENU_LOAD_API_SCOPE_DRAWER(payload) {
  return {
    type: `${MENU_NAMESPACE}/loadApiScopeDrawer`,
    payload,
  };
}
...
export function MENU_LOAD_API_SCOPE_DICT() {
  return {
    type: `${MENU_NAMESPACE}/loadApiScopeDict`,
    payload: { code: 'api_scope_type' },
  };
}
