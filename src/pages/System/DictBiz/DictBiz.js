...
import { DICT_PARENT_LIST, DICT_PARENT_CLEAR } from '../../../actions/dictbiz';
...
@Form.create()
class DictBiz extends PureComponent {
  componentDidMount() {
  ...
  handleClick = parentId => {
    router.push(`/system/dictbiz/sub/${parentId}`);
  };
