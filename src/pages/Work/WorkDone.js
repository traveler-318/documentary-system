...
import { WORK_INIT, WORK_DONE_LIST } from './actions/work';
...
class WorkDone extends PureComponent {
  ...
  handleSearch = params => {
    ...
    dispatch(WORK_DONE_LIST(payload));
  };
