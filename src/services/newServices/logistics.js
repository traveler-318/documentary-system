...
export async function shipperList(params) {
  return request(`/api/logistics/recipient/list?size=`+params.size+`&current=`+params.current, {
    method: 'GET'
  });
}

export async function shipperSave(params) {
  return request('/api/logistics/recipient/save', {
    method: 'POST',
    body: params,
  });
}
...
export async function shipperUpdate(params) {
  return request('/api/logistics/recipient/update', {
    method: 'POST',
    body: params,
  });
}
